...
CREATE TABLE IF NOT EXISTS `mydb`.`curtida` (
  ...
  INDEX `fk_usuario_has_postagem_postagem2_idx` (`postagem_idpostagem` ASC) VISIBLE,
  INDEX `fk_usuario_has_postagem_usuario2_idx` (`usuario_idusuario` ASC) VISIBLE,
